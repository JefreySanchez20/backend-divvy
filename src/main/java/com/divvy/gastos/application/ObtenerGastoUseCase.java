...
public class ObtenerGastoUseCase {

    private final GastoRepository gastoRepository;
    private final VerificadorMiembroGrupo verificadorMiembroGrupo;

    public ObtenerGastoUseCase(GastoRepository gastoRepository, VerificadorMiembroGrupo verificadorMiembroGrupo) {
        this.gastoRepository = gastoRepository;
        this.verificadorMiembroGrupo = verificadorMiembroGrupo;
    }

    public Gasto ejecutar(UUID actorId, UUID grupoId, UUID gastoId) {
